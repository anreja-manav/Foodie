    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otp_max_out', models.CharField(blank=True, max_length=2, null=True)),
                ('name', models.CharField(blank=True, max_length=100, null=True)),
                ('role', models.CharField(choices=[('admin', 'Admin'), ('delivery', 'Delivery'), ('customer', 'Customer'), ('vendor', 'Vendor')], default='customer', max_length=10)),
                ('profile_pic', models.ImageField(blank=True, default='assests/users/default_user.png', null=True, upload_to='assets/users/')),
